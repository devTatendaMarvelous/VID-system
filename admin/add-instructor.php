...
if(isset($_POST['btn_instructor'])){
    ...
    $insert_query = mysqli_query($con, "INSERT INTO instructors(firstname, lastname, dob, idnumber, email, driving_school, contactno, image, password) VALUES('$fname', '$lname', '$dob', '$idnum', '$email', '$dschool', '$mobileno', '$post_image','$pword')");
...
<head>
    ...
    <title>Add Instructor | VID </title>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Add Instructor</a></li>
                                                ...
                                                <div id="dropzone1" class="pro-ad">
                                                    <form method="post" enctype="multipart/form-data" class="needsclick add-professors" id="demo1-upload">
                                                                ...
                                                                <div class="form-group">
                                                                 ...
                                                                 <div class="form-group">
                                                                    <input name="imageupload" type="file" class="form-control" required>
                                                                </div> 
                                                               
                                                        <div class="row">
                                                            <div class="col-lg-12">
                                                                <div class="payment-adress">
                                                                    <button type="submit" class="btn btn-primary waves-effect waves-light" name="btn_instructor">Add Instructor</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
